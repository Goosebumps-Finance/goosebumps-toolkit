...
export const footerLinks: FooterLinkType[] = [
  ...
  },
  {
    ...
    items: [
      {
        label: "Customer",
        href: "Support https://docs.goosebumps.finance/contact-us/customer-support",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Bug Bounty",
        href: "https://app.gitbook.com/@goosebumps-1/s/goosebumps/code/bug-bounty",
      },
      {
        label: "Audits",
        href: "https://docs.goosebumps.finance/help/faq#is-pancakeswap-safe-has-pancakeswap-been-audited",
      },
      {
        label: "Careers",
...
export const socials = [
  {
    label: "Twitter",
    icon: "Twitter",
    href: "https://twitter.com/goosebumps",
  },
  {
    label: "Telegram",
    icon: "Telegram",
    items: [
      {
        label: "English",
        href: "https://t.me/goosebumps",
      },
      {
        label: "Bahasa Indonesia",
        href: "https://t.me/GooseBumpsIndonesia",
      },
      {
        label: "中文",
